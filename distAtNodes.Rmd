...
When a node does not contains a large number of individuals, estimates of distribution of the response variable at that node is subject to a great deal of chance variation.  Watch for this especially when you are building trees with many nodes, or when your training or test sets are not large to being with. 
