...
Consider the `m111survey` data frame from the `tigerstats` package, and say that we constuct a tree to predict the sex of a person from the other variables in this data frame:
...
Is ideal_ht < 72.5 (y/n)? n
Is seat one of: 1_front, 2_middle (y/n)? n
I have reached a leaf with 5 items.
