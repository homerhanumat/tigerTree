...
The result is list of two desired data frames:

```{r}
str(myTrainTest)
```

For convenience, let's give them shorter names:
...
The first tree we made has only four nodes, and misclassification rate on the quiz data is very high:  about 10.16%.
